...
function make_card(id, img_src, name, big_title, company, company_logo, loan, min_price, max_price) {
    ...
    var $new = '<div class="col-lg-4 col-md-6 d-flex align-items-stretch">'+
        ...
        '<div class="card-body"><h3 class="card-title"><a onclick="detailsFunction(\'' + id + '\')"><span>' + big_title + '</span>'+ name + '</a></h3>'+
...
// for(let i=0; i<10; i++) {
//     make_card("https://imgauto-phinf.pstatic.net/20200120_102/auto_15794898060156jqIM_PNG/20200120120943_3WuAR8Ei.png?type=f152_110",
//         '2021 k5', '현대',
