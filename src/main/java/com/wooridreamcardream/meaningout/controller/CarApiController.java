...
public class CarApiController {
    ...
    public List<CarWooriResponseDto> dream(@RequestParam("user-income") String user_income, @RequestParam("minimum") BigDecimal minimum, @RequestParam("maximum") BigDecimal maximum, @RequestParam("people") int people, @RequestParam("body-type") String body_type,
        ...
        return carService.dream(user_income, minimum, maximum, people, body_type, environmental_protection, fuel_economy, boycott_in_japan, patriotic_campaign, vegan);
    }
}
